	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading pull-center">Panel de Administración</div>
				<div class="panel-body">
					<form action="include/logeateadmin.php" method="POST" data-wow-offset="10" data-wow-delay="0.2s">
						<fieldset>

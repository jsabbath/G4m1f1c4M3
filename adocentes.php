...
function damedocentes(){
    ...
    $consulta_mysql="
    SELECT * from persona where persona.chrtipopersona = '3'
    ";
    ...
    while($registro = mysql_fetch_array($resultado_consulta_mysql)){
        echo "
            <tr>
                ...
                <td>
                    <label>
                      <a class='label label-success' href='achatroom.php?intidpersona=<?php echo $r->intidpersona; ?>'>Escribirle un mensaje</a>
                    </label>
                </td>
            </tr>
        ";
            ...
            <div class="container-fluid">
                <div class="row">
                                          ...
                                          <div class="col-md-12">
                                              <div class="card card-plain">
                                                  <div class="content table-responsive table-full-width">
                                                      <label>Te encuentras en la seccion de cha con el docente, en esta interfaz puedes conversar con el profesor</label>
                                                      <ul>
                                                          <li>Al lado derecho tienes la lista de docentes de las diferentes clases de los cursos dentro de gamificame.</li>
                                                          <li>Selecciona el docente con el que deses conversar o preguntarle algo, dando click sobre 'DEJAR MENSAJE'</li>
                    ...
                    <div class="col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Tabla de docentes</h4>
                                <!--p class="category">Here is a subtitle for this table</p-->
                            </div>
                            <div class="content">
                                  <div class="container-fluid">
                                                          ...
                                                          <tbody>
                                                                <?php foreach($model->Listardocentes() as $r): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <form action="achatroom.php" method="POST">
